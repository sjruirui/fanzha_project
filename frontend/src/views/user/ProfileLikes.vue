...
async function fetchLikes() {
  loading.value = true
  try {
    const res = await profileApi.getLikes({
      page: page.value,
...
function goToDetail(item: LikeItem) {
...
<template>
  <div class="profile-likes-page card">
    <div class="header">
    ...
    <div v-loading="loading" class="like-list">
      <div v-if="likes.length === 0 && !loading" class="empty-state">
